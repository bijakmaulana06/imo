...
export default function Card({
  ...
  const colorMap = {
    cyan: {
      shadow: "hover:shadow-[0_16px_48px_rgba(125,249,255,0.2)] hover:border-accent-cyan/60",
    ...
    purple: {
      shadow: "hover:shadow-[0_16px_48px_rgba(180,140,255,0.2)] hover:border-accent-purple/60",
    ...
    yellow: {
      shadow: "hover:shadow-[0_16px_48px_rgba(255,209,102,0.2)] hover:border-accent-yellow/60",
  ...
  return (
    <div
      className={`group relative rounded-2xl glass p-6 border border-white/10 backdrop-blur-2xl transition-all duration-300 transform hover:-translate-y-1 ${currentTheme.shadow} ${className}`}
      {...props}
    >
      {/* Subtle Background Grid Texture */}
      <div className="absolute inset-0 bg-[radial-gradient(rgba(255,255,255,0.03)_1px,transparent_1px)] [background-size:20px_20px] rounded-2xl pointer-events-none" />

      {/* Top Accent Laser Line */}
      <div
        className={`absolute top-0 left-4 right-4 h-[1.5px] bg-gradient-to-r ${currentTheme.topLine} opacity-40 group-hover:opacity-100 transition-opacity duration-300`}
      />
